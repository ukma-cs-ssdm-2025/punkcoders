...
from accounts.serializers import ManagerUserCreateSerializer, ManagerUserSerializer, SelfUserSerializer
...
class UserSerializerTests(TestCase):
    ...
    def setUp(self):
        ...
        self.courier_user = User.objects.create_user(
            ...
            first_name="Courier",
            last_name="User",
            password="password123wresbipdjiq3iwbr",
    ...
    def test_self_user_update_no_password(self):
        ...
        self.assertTrue(instance.check_password("password123wresbipdjiq3iwbr"), "Password should not have changed.")

    def test_self_user_update_with_password(self):
        """Test updating user details including the password."""
        data = {"first_name": "NewName", "password": "newpassword456raewdvs"}
        serializer = SelfUserSerializer(self.courier_user, data=data, partial=True)
        ...
        self.assertTrue(instance.check_password("newpassword456raewdvs"), "Password should be updated.")
        self.assertFalse(instance.check_password("password123wresbipdjiq3iwbr"), "Old password should no longer work.")
    ...
    def test_manager_create_serializer_create_user(self):
        ...
        data = {
            ...
            "first_name": "New",
            "last_name": "Kitchen",
            "password": "kitchenpasswordaerbdaeWREVS",
        ...
        self.assertTrue(instance.check_password("kitchenpasswordaerbdaeWREVS"))
