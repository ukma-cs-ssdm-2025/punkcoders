...
from restaurant.models import Dish, Category, Ingredient, DishIngredient
...
def update_dish(pk, data):
    ...
    try:
        ...
        # 1. Оновлення основних полів (PATCH)
        changed = False
