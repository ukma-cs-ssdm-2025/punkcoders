        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "slug",
                    models.SlugField(
                        help_text="URL-friendly назва категорії (автоматично генерується).", max_length=100, unique=True
                    ),
                ),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                (
                    "dish",
                    models.ForeignKey(
                        on_delete=django.db.models.deletion.CASCADE, to="restaurant.dish", verbose_name="Страва"
                    ),
                ),
                (
                    "ingredient",
