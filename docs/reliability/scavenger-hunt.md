...
| 2 | Відсутній "Запобіжник" (Error Boundary) | **High** | **Error Boundary** (Запобіжник) / **Fallback UI** |  **Не Виправлено** |
| 3 | Відсутня валідація на `min` (ціна) | **Medium** | **Guard Clause** (Рання перевірка / Захист) | **Не Виправлено** |
