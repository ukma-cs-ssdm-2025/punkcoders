...
| 8 | 404 не обробляється окремо на клієнті | Немає if для 404 окремо від інших помилок | ??? | Користувач бачить незмістовне повідомлення про помилку | Low | ✅ Виправлено |
