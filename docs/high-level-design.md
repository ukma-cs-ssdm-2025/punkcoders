...
- **Чому так:**  
  - Баланс між **простотою** й **гнучкістю** ([ADR-001](docs/decisions/ARD-001.md))
  - Швидкий старт і структурованість з **Django** ([ADR-002](docs/decisions/ARD-002.md))
...
- [ADR-001](docs/decisions/ARD-001.md): 3-шарова клієнт–серверна архітектура 
- [ADR-002](docs/decisions/ARD-002.md) Django як бекенд-фреймворк 
- [ADR-003](docs/decisions/ARD-003.md): Фільтрація/сортування меню на клієнті 
- [ADR-004](docs/decisions/ARD-004.md) PostgreSQL як основна БД 
