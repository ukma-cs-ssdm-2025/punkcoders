...
- **Чому так:**  
  - Баланс між **простотою** й **гнучкістю** ([ADR-001](decisions/ADR-001.md)) 
  - Швидкий старт і структурованість з **Django** ([ADR-002](decisions/ADR-002.md))
...
- [ADR-001](decisions/ADR-001.md): 3-шарова клієнт–серверна архітектура 
- [ADR-002](decisions/ADR-002.md): Django як бекенд-фреймворк 
- [ADR-003](decisions/ADR-003.md): Фільтрація/сортування меню на клієнті 
- [ADR-004](decisions/ADR-004.md): PostgreSQL як основна БД 
