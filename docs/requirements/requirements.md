...
- **FR-018**: ***Система дозволяє вказати адресу як спосіб доставки***.
- *FR-005*: Система дозволяє вказати самовивіз як спосіб доставки.
...
- **FR-053**: Кур'єр може сортувати адреси доставок за відстанню до кур'єра.
...
- **FR-059**: ***Система показує клієнтам номер техпідтримки.***
