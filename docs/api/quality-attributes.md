...
|--------------|------------------------------|
| **Performance (Швидкодія)** | 95% запитів відповідають за <200 мс |
| **Security (Безпека)** | Тести з некоректними даними не викликають падіння API |
| **Reliability (Надійність)** | Некоректні запити повертають 400 або 422 |
